...
export function FunnelChart({
  ...
  // Percentuais de conversão entre etapas (0% quando não houver dados)
  const pctClicks = 100
  ...
  return (
    <div className="bg-white dark:bg-[#081A33] rounded-2xl border border-slate-200/90 dark:border-[#142C52] p-6 shadow-sm">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors" title="Fluxo contínuo do anúncio até o pagamento aprovado">
                  ...
                  {step.isFirst ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      ...
                      >
                        ...
                        {/* Curva suave de funil de cima e baixo até a linha central (y=50) na borda direita */}
                        <path
                    ...
                    <div className="relative w-full flex items-center justify-center">
                      {/* Linha horizontal contínua passando no eixo central */}
                      <div className="absolute left-0 right-0 h-[1.5px] bg-slate-300 dark:bg-slate-700 z-0" />
                      
                      {/* Percentual com fundo para sobrepor a linha limpa */}
